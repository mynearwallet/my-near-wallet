...
const CopyIcon = ({ color }) => {
    ...
    return (
        ...
        >
            <path
                d='M15 7.48071H8.25C7.42157 7.48071 6.75 8.15229 6.75 8.98071V15.7307C6.75 16.5591 7.42157 17.2307 8.25 17.2307H15C15.8284 17.2307 16.5 16.5591 16.5 15.7307V8.98071C16.5 8.15229 15.8284 7.48071 15 7.48071Z'
                stroke={stroke}
                strokeWidth='1.5'
                strokeLinecap='round'
