...
const CloseButton = ({ onClick, device }) => (
    <Container onClick={onClick} title='Close' className={classNames(['modal-close-btn', device])}>
        <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path className='icon' d="M22.9954 11.6817L11.6817 22.9954M11.6817 11.632L22.9954 22.9458" stroke="var(--mnw-color-inactive-3)" strokeWidth="2.5" strokeLinecap="round"/>
        </svg>
    </Container>
);
