...
const AlertContainer = styled.div`
    ...
    animation: alertAnimation ease-in-out 0.3s;
...
const Alert = styled.div`
    ...
    &.number-${(props) => props.closing} {
        animation: alertAnimationClose ease-in-out 0.3s forwards;
    }
    animation-iteration-count: 1;
    transform-origin: 50% 50%;
                                ...
                                .map((alert, i) => {
                                    const msgCode =
                                        typeof translate(alert.messageCode) === 'string'
                                            ...
                                            : '';
                                    const noTranslationFound = msgCode.includes(
                                        'No default translation found!'
                                    );
                                    return (
                                        <Alert
                                            key={`alert-${i}`}
                                            ...
                                            <Content>
                                                <Icon>
                                                    <img
                                                        src={
                                                            alert.success
                                                                ? IconCheckCircleImage
                                                                : IconsAlertCircleImage
                                                        }
                                                        alt=''
                                                    />
                                                </Icon>
