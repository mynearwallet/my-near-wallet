...
export const startEarningSection = {
  ...
  colour:
    "linear-gradient(0deg, #F4FFEE, #F4FFEE), linear-gradient(0deg, #ECFFE3, #ECFFE3), linear-gradient(0deg, #ECFFE3, #ECFFE3), #ECFFE3;",
  sectionLink: "defi",
  projects: [
    {
      icon: burrowIcon,
...
export const collectNFTsSection = {
  ...
  colour:
    "linear-gradient(0deg, #FEF4FF, #FEF4FF), linear-gradient(0deg, #ECFFE3, #ECFFE3), linear-gradient(0deg, #ECFFE3, #ECFFE3), #ECFFE3;",
...
export const playToEarnSection = {
  ...
  colour:
    "linear-gradient(0deg, #F7F7FF, #F7F7FF), linear-gradient(0deg, #ECFFE3, #ECFFE3), linear-gradient(0deg, #ECFFE3, #ECFFE3), #ECFFE3;",
  sectionLink: "gaming",
  projects: [
    {
      icon: metamonIcon,
