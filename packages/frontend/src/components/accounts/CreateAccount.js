...
class CreateAccount extends Component {
  ...
  render() {
    ...
    const showTermsPage =
      CONFIG.IS_MAINNET && !isLinkDrop && !termsAccepted && !ENABLE_IDENTITY_VERIFIED_ACCOUNT;
    ...
    if (showTermsPage) {
      return (
        <StyledContainer className='small-centered border'>
          ...
          <FormButton color='gray' className='link' onClick={() => this.props.redirectTo("/")}>
...
const CreateAccountWithRouter = connect(mapStateToProps, mapDispatchToProps)(CreateAccount);
