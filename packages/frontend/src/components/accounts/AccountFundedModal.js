  ...
  return (
    <SwapAccountContainer>
        ...
        <div className='implicit'>
          ...
          >
            <g clipPath="url(#clip0)">
              <path
                d="M2.32959 4.71051H3.66292H14.3296"
                stroke="#FF585D"
                strokeWidth="1.5"
                strokeLinecap="round"
      ...
      <div>
        ...
        >
          <path
            d="M15.1401 10.4829L20.1401 15.4829L15.1401 20.4829"
            stroke="#2B9AF4"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M4.14014 4.48291V11.4829C4.14014 12.5438 4.56156 13.5612 5.31171 14.3113C6.06185 15.0615 7.07927 15.4829 8.14014 15.4829H20.1401"
            stroke="#2B9AF4"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        <div className='account-id'>
          ...
          >
            <path
              d="M13.3496 4.80005L6.01632 12.1334L2.68298 8.80005"
              stroke="#008D6A"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
...
const AccountFundedModal = ({
  ...
  return (
    <Modal id='account-funded-modal' isOpen={open} onClose={onClose} disableClose={true}>
      <Container>
        <SwapAccountGraphic
          accountId={accountId || "johndoe.near"}
          implicitAccountId={implicitAccountId || "cd03cbd02b6e0fbfd51bdb42bfe60e"}
        />
        <h1>
          <Translate id='account.createImplicit.post.modal.title' />
        </h1>
        <div className='sub-title'>
          <Translate id='account.createImplicit.post.modal.descOne' />
        </div>
        <div className='sub-title'>
          <Translate id='account.createImplicit.post.modal.descTwo' />
        </div>
