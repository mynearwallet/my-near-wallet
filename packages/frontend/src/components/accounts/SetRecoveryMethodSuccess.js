    ...
    return (
      <Container>
        ...
        <div className='desc one'>
          <Translate
            id={`setRecoveryConfirm.pageText.one.${recoverWithEmail ? "email" : "phoneNumber"}`}
          />
        </div>
        <div className='desc two'>
          <Translate
            id={`setRecoveryConfirm.pageText.two.${recoverWithEmail ? "email" : "phoneNumber"}`}
          />
        </div>
        ...
        <div className='re-enter'>
          ...
          <Translate
            id={`setRecoveryConfirm.reenter.two.${recoverWithEmail ? "email" : "phoneNumber"}`}
          />
        </div>
      </Container>
    );
