    ...
    return (
      ...
      >
        ...
        <g clipPath="url(#clip123230)">
          <path
            d="M8.66667 16C8.66667 16 11.3333 10.6666 16 10.6666C20.6667 10.6666 23.3333 16 23.3333 16C23.3333 16 20.6667 21.3333 16 21.3333C11.3333 21.3333 8.66667 16 8.66667 16Z"
            stroke="#2B9AF4"
            strokeWidth="1.5"
            strokeLinecap="round"
  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#clip3123990)">
        ...
        />
        <path
          d="M8.66667 8.66669L23.3333 23.3334"
          stroke="#2B9AF4"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
