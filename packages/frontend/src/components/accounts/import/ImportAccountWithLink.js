...
export default ({ accountsBySeedPhrase, onClickAccount, importingAccount }) => {
    ...
    const getAccountsStatus = () => {
        if (numberOfAccountsFound === 1 && accountsBySeedPhrase[0].imported) {
            return (
                <h2>
                    <Translate id='importAccountWithLink.alreadyImported' />
                </h2>
            );
        }
        ...
        if (numberOfAccountsFound !== 1) {
            return (
                <h2>
                    <Translate
                        id='importAccountWithLink.foundAccounts'
                        data={{ count: numberOfAccountsFound }}
                    />
                </h2>
            );
        }
        ...
        return (
            <h2>
                <Translate id='importAccountWithLink.foundAccount' />
            </h2>
        );
    };
    ...
    return (
        <StyledContainer className='small-centered border'>
            <h3>
                <Translate id='importAccountWithLink.importAccount' />
            </h3>
            ...
            <h2>
                ...
                <ClickToCopy copy={window.location.href} className='copy'>
                    <FormButton
                        ...
                        trackingId='IE with link Click copy url button'
                    >
