...
const EnterVerificationCode = ({
  ...
  const shouldRenderRecaptcha =
    !skipRecaptcha && !isLinkDrop && CONFIG.RECAPTCHA_CHALLENGE_API_KEY && isNewAccount;
    ...
    <StyledContainer className='small-centered border'>
      <form onSubmit={handleOnSubmit} autoComplete='off'>
        ...
        <h2>
          ...
          <Translate id={useEmail ? "setRecoveryConfirm.email" : "setRecoveryConfirm.phone"} />:{" "}
        ...
        <FormButton
          ...
          type='submit'
          disabled={
            code.length !== 6 || verifyingCode || (!recaptchaToken && shouldRenderRecaptcha)
          }
