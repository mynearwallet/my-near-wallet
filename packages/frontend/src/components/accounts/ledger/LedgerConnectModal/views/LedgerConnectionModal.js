...
const LedgerConnectionModal = ({ connecting, connect, cancel, modalType }) => (
  <>
    ...
    <div className='buttons'>
      <FormButton className='gray link' onClick={cancel}>
        <Translate id={`connectLedger.modal.${modalType}.cancelButton`} />
      </FormButton>
      <FormButton onClick={connect} sending={connecting} sendingString='button.connecting'>
