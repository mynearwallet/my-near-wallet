...
import { selectAccountFullAccessKeys, selectAccountSlice } from "../../../redux/slices/account";
import {
...
const HardwareDevices = ({
  ...
  const loadingStatus = useSelector((state) => selectRecoveryMethodsStatus(state, { accountId }));
