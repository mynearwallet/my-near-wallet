...
export default {
  ...
  REACT_APP_USE_TESTINGLOCKUP: parseBooleanFromShell(process.env.REACT_APP_USE_TESTINGLOCKUP),
  ...
  SMS_BLACKLIST: envValIsSet(process.env.SMS_BLACKLIST)
    ? parseCommaSeperatedStringAsArrayFromShell(process.env.SMS_BLACKLIST.replace(/\s/g, ""))
    : undefined,
  STAKING_GAS_BASE: process.env.REACT_APP_STAKING_GAS_BASE,
  WHITELISTED_CONTRACTS: parseCommaSeperatedStringAsArrayFromShell(process.env.TOKEN_CONTRACTS),
