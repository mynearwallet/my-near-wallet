        ...
        : {
            success:
              typeof ready === "undefined"
                ...
                : undefined,
            pending:
              typeof ready === "undefined" ? undefined : !meta?.alert?.ignoreMainLoader && !ready,
          ...
          ? {
              show:
                typeof ready === "undefined"
                  ? true
                  : ready &&
                    ((meta?.alert?.onlyError && error) || (meta?.alert?.onlySuccess && !error)),
              ...
              console:
                (error || (type === "SHOW_CUSTOM_ALERT" && payload.errorMessage)) &&
...
const clearReducer = handleActions(
  {
    [clearLocalAlert]: (state) =>
      Object.keys(state).reduce(
        (obj, key) => (key !== "localAlert" ? ((obj[key] = state[key]), obj) : obj),
        {},
      ),
