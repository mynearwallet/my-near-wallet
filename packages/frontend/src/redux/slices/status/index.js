...
export const selectStatusMainLoader = createSelector(
  selectStatusSlice,
  (status) => status.mainLoader || false,
);

export const selectStatusLocalAlert = createSelector(
  selectStatusSlice,
  (status) => status.localAlert || {},
);

export const selectStatusActionStatus = createSelector(
  selectStatusSlice,
