...
const parseAndFormatArguments = (encodedArgs) => {
    ...
    try {
        ...
        console.log(
            'Cannot parse function call args as JSON. Display raw base64 string.',
            encodedArgs
        );
        return encodedArgs;
    }
...
export default function getTranslationsFromMultisigRequest({
    actions,
    receiver_id,
    account_id,
}) {
    const fullAccessKeyAction = actions.find(
