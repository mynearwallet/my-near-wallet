...
export const FARMING_VALIDATOR_REGEXP_TESTNET = new RegExp(
  `.*(${FARMING_VALIDATOR_PREFIXES_TESTNET.join("|")}|${VALIDATOR_PREFIXES_TESTNET.join("|")})`,
);
export const FARMING_VALIDATOR_REGEXP_MAINNET = new RegExp(
  `.*(${FARMING_VALIDATOR_PREFIXES_MAINNET.join("|")}|${VALIDATOR_PREFIXES_MAINNET.join("|")})`,
);
