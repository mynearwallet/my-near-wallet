...
describe('shortenAccountId', () => {
    test('should shorten account ID with correct format', () => {
        const sourceId =
            '4ee68bC02dd892aa1ad819101f3adf4cfafb90e3f73b827f4c2352b6efe363ek';
        ...
        expect(shortenAccountId(sourceId, 30, 31)).toBe(
            '4ee68bC02dd892aa1ad819101f3adf...afb90e3f73b827f4c2352b6efe363ek'
        );
    });
