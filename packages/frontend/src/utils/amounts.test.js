...
describe('amounts', () => {
    ...
    test('should correctly format token amount', () => {
        ...
        expect(amounts.formatTokenAmount('1441951941493024720139950', 24, 3)).toBe(
            '1.442'
        );
        expect(amounts.formatTokenAmount('1000000000000000000000000', 24)).toBe('1.00');
        expect(amounts.formatTokenAmount('1000000000000000000000000', 24, 4)).toBe(
            '1.0000'
        );
    });
    ...
    test('should correctly parse token amount', () => {
        ...
        expect(amounts.parseTokenAmount('1.44195194149302472013995', 24)).toBe(
            '1441951941493024720139950'
        );
        expect(amounts.parseTokenAmount('1.44195194149302472013995', 24, 3)).toBe(
            '1441951941493024720139950.000'
        );
    });
    ...
    test('should correctly remove trailing zeros', () => {
        ...
        expect(amounts.removeTrailingZeros('1.0000000000000000000000000001')).toBe(
    ...
    test('should correctly decrease amount by percent', () => {
        ...
        expect(amounts.decreaseByPercent(0.000079630313987476842385, 0.1, 10)).toBe(
            '0.0000795507'
        );
    ...
    test('should correctly cut specified amount of decimal places if necessary', () => {
        ...
        expect(
            amounts.toSignificantDecimals(
                '1000000000000000000000000000000000000000000',
                3
            )
        ).toBe('1000000000000000000000000000000000000000000');
        expect(amounts.toSignificantDecimals(1.1)).toBe('1.1');
        ...
        expect(amounts.toSignificantDecimals(0.00005, 6)).toBe('0.00005');
        ...
        expect(
            amounts.toSignificantDecimals(
                '1.000000000000000000000000000000000012345678',
                4
            )
        ).toBe('1.00000000000000000000000000000000001234');
        expect(
            amounts.toSignificantDecimals('1.000000000000000000000000000000000012345678')
        ).toBe('1.000000000000000000000000000000000012');
    });
    ...
    test('should correctly separate integer part with commas', () => {
        ...
        expect(amounts.integerPartWithCommaSeparators('123123123.12')).toBe(
            '123,123,123.12'
        );
    });
    ...
    test('should correctly format balance', () => {
        ...
        expect(amounts.formatBalance('10000000000000000000000000000000000', 24)).toBe(
            '10000000000'
        );
        ...
        expect(amounts.formatBalance('1441951941493024720139950', 24)).toBe(
            '1.44195194149302472013995'
        );
    });
});
