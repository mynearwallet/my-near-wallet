...
describe("amounts", () => {
  ...
  test("should correctly cut specified amount of decimal places if necessary", () => {
    ...
    expect(amounts.toSignificantDecimals("1000000000000000000000000000000000000000000", 3)).toBe(
    ...
    expect(amounts.toSignificantDecimals("1.000000000000000000000000000000000012345678", 4)).toBe(
      "1.00000000000000000000000000000000001234",
    );
    expect(amounts.toSignificantDecimals("1.000000000000000000000000000000000012345678")).toBe(
      "1.000000000000000000000000000000000012",
    );
  });
