    ...
    const setTab = (nextTab) => {
      if (tab !== nextTab) {
        ...
        this.props.history.push({
          search: stringify({ tab: nextTab }, { skipNull: true, skipEmptyString: true }),
          hash,
        });
      }
    };

    const hideFooterOnMobile = [WALLET_LOGIN_URL, WALLET_SEND_MONEY_URL, WALLET_SIGN_URL].includes(
      pathname.replace(/\//g, ""),
    );
    ...
    return (
      <Container
        className={classNames([
          "App",
          {
            "network-banner": !CONFIG.IS_MAINNET || CONFIG.SHOW_PRERELEASE_WARNING,
          },
        ...
        <ConnectedRouter basename={PATH_PREFIX} history={this.props.history}>
          <ThemeProvider theme={theme}>
            ...
            <Switch>
              ...
              />
              <Route exact path="/create" component={CreateAccountWithRouter} />
              <Route
                exact
              ...
              />
              <Route exact path="/verify-account" component={VerifyAccountWrapper} />
              <Route exact path="/initial-deposit" component={InitialDepositWrapper} />
              <Route exact path="/fund-with-existing-account" component={ExistingAccountWrapper} />
              <Route
                exact
                path="/fund-create-account/:accountId/:implicitAccountId/:recoveryMethod"
                component={SetupImplicitWithRouter}
              />
              <Route exact path="/setup-ledger/:accountId" component={SetupLedgerWithRouter} />
              <PrivateRoute
                exact
                path="/setup-ledger-success"
                component={SetupLedgerSuccessWithRouter}
              />
              <PrivateRoute exact path="/enable-two-factor" component={EnableTwoFactor} />
              <Route
              ...
              <Route
                ...
                path="/batch-import"
                render={() => (
                  <BatchImportAccounts onCancel={() => this.props.history.replace("/")} />
                )}
              />
              <Route exact path="/batch-ledger-export" component={BatchLedgerExport} />
              <Route exact path="/sign-in-ledger" component={SignInLedgerWrapper} />
              ...
              />
              <PrivateRoute exact path="/send-money/:accountId?" component={SendContainerWrapper} />
              <PrivateRoute
                exact
                path="/nft-detail/:contractId/:tokenId"
                component={NFTDetailWrapper}
              />
              <PrivateRoute exact path="/receive-money" component={ReceiveContainerWrapper} />
              ...
              <PrivateRoute exact path="/profile/:accountId?" component={Profile} />
              <PrivateRoute
                exact
                path="/sign"
                render={() => <SignWrapper urlQuery={parse(this.props.router.location.hash)} />}
              />
              <PrivateRoute
                path="/staking"
              ...
              <Route exact path="/cli-login-success" component={LoginCliLoginSuccess} />
              <Route exact path="/terms" component={Terms} indexBySearchEngines={true} />
              <Route exact path="/privacy" component={Privacy} indexBySearchEngines={true} />
              {WEB3AUTH_FEATURE_ENABLED && (
                <PrivateRoute exact path="/verify-owner" component={VerifyOwnerWrapper} />
              )}
